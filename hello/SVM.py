...
def innerL(i, oS): #输入参数i和所有参数数据
    Ei = calcEk(oS, i) #计算E值
    #检验这行数据是否符合KKT条件 参考《统计学习方法》p128公式7.111-113，若不符合寻找a
...
#主程序
def main():
    filename_traindata='E:\\lian_workspace\\Files\\svm_train.csv'
    filename_testdata='E:\\lian_workspace\\Files\\svm_test.csv'
